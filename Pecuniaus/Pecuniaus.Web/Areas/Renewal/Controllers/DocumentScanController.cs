    ...
    public class DocumentScanController : BaseController
    {
        ...
        public ActionResult Complete()
        {
            ...
            if (ValidateComplete())
            {
                ...
                renewaltApi.CompContractTask(CurrentMerchantID, (int)TaskTypes.RWDocumentVerification, (int)WorkflowTypes.Renewal, ContractID);
        ...
        {
            var rv = false;
            var doc = documentsApi.RetriveDocument(CurrentMerchantID, ContractID, (int)Pecuniaus.Renewal.DocumentTypes.LegalDocumentsOfTheCompany);
        ...
        {
            var docTypes = contractApi.GetDocument(2);
