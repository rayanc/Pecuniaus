...
namespace Pecuniaus.Validators
{
    public class MPMerchantBusinessInfoValidator : AbstractValidator<MPMerchantBusinessInfoModel>
    {
        public MPMerchantBusinessInfoValidator()
        {
            ...
            RuleFor(m => m.businessCCStartDate)
                .NotNull().WithMessage(ValidationMessages.DateBusinessStartedCCReq);
    ...
    public class MPMerchantAddressInfoValidator : AbstractValidator<MPMerchantAddressInfoModel>
    {
        public MPMerchantAddressInfoValidator()
        {
            ...
            RuleFor(m => m.Cell)
                .Matches(ValidationRules.Telephone).WithMessage(ValidationMessages.CellphoneVal).When(m => m.Cell != null);
            //RuleFor(m => m.City)
    ...
    //            .LessThanOrEqualTo(DateTime.Today).WithMessage(ValidationMessages.FromDateVal).When(m => m.ActivityFrom.HasValue);
    ...
    //            .NotEmpty().WithMessage(ValidationMessages.FromDateReq)
    //            .LessThanOrEqualTo(DateTime.Today).WithMessage(ValidationMessages.FromDateVal).When(m => m.StatementsFrom.HasValue);
    ...
    //            .NotEmpty().WithMessage(ValidationMessages.FromDateReq)
    //            .LessThanOrEqualTo(DateTime.Today).WithMessage(ValidationMessages.FromDateVal).When(m => m.HistoryStartDate.HasValue);

    //        RuleFor(m => m.HistoryEndDate)
    //        .NotEmpty().WithMessage(ValidationMessages.ToDateReq)
    //        .GreaterThan(m => m.HistoryStartDate).WithMessage(ValidationMessages.ToDateVal).When(m => m.HistoryStartDate.HasValue);
    //    }
    //}
    ...
    //            .LessThanOrEqualTo(DateTime.Today).WithMessage(ValidationMessages.FromDateVal).When(m => m.StartDate.HasValue);

    //        RuleFor(m => m.EndDate)
    //        .NotEmpty().WithMessage(ValidationMessages.ToDateReq)
    //        .GreaterThan(m => m.StartDate).WithMessage(ValidationMessages.ToDateVal).When(m => m.StartDate.HasValue);
    //    }
    //}
