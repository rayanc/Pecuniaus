...
CREATE TABLE `tb_documents` (
  ...
  KEY `FK__tb_Docume__Docum__0C85DE4D` (`DocumentTypeId`),
  KEY `FK__tb_Docume__MERCH__0E6E26BF` (`MERCHANTID`),
  CONSTRAINT `FK__tb_Docume__Docum__0B91BA14` FOREIGN KEY (`DocumentTypeId`) REFERENCES `lkp_tb_documenttypes` (`DocumentTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK__tb_Docume__MERCH__0D7A0286` FOREIGN KEY (`MERCHANTID`) REFERENCES `tb_merchants` (`MerchantId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK__tb_Docume__MERCH__0E6E26BF` FOREIGN KEY (`MERCHANTID`) REFERENCES `tb_merchants` (`MerchantId`) ON DELETE NO ACTION ON UPDATE NO ACTION
