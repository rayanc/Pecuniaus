...
CREATE TABLE `tb_addresses` (
  ...
  CONSTRAINT `FK_AddressTypeId_lkp_addressType` FOREIGN KEY (`AddressTypeId`) REFERENCES `lkp_tb_addresstype` (`AddressTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_contracts` (
  ...
  CONSTRAINT `FK_tb_Contracts_DeclineReasons` FOREIGN KEY (`DeclineReasonID`) REFERENCES `lkp_tb_declinereasons` (`DeclineReasonId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `tb_merchantactivities` (
  ...
  CONSTRAINT `FK_tb_MerchantActivitietypeId_tb_ActivityType` FOREIGN KEY (`ActivityTypeId`) REFERENCES `tb_activitytype` (`ActivityTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_prequalusers` (
  ...
  KEY `FK_TaskTypeID_lkp_tb_tasktypes_idx` (`TaskTypeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_processor` (
  ...
  CONSTRAINT `FK_tb_Processor_Gen_tb_ProcessorList` FOREIGN KEY (`ProcessorTypeId`) REFERENCES `lkp_tb_processorlist` (`ProcessorId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_tasks` (
  ...
  CONSTRAINT `FK_tasktypeid_tasks_tb_taskstypes` FOREIGN KEY (`TaskTypeId`) REFERENCES `tb_tasktypes` (`TaskTypeId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tb_tasktypes` VALUES (1,1,'Merchant Review','sp',1,0,1),(1,2,'Scan Document','sp',1,0,2),(1,3,'Data Entry','sp',1,0,3),(1,4,'Monthly Credit Card Volumes','sp',1,0,4),(1,5,'Merchant Evaluation','sp',1,0,5),(1,6,'Offer Creation','sp',1,0,6),(1,7,'Offer Acceptance','sp',1,0,7),(2,8,'CW  - Scan Document','sp',1,0,1),(2,9,'CW - Verification Call','sp',1,0,2),(2,10,'CW - Data Entry','sp',1,0,3),(2,11,'CW - Bank Information Verification','sp',1,0,4),(2,12,'CW - Corporate Documents Verification','sp',1,0,4),(2,13,'CW - Commercial Name Verification','sp',1,0,4),(2,14,'CW - Landlord Verification','sp',1,0,4),(2,15,'CW - Review','sp',1,0,5),(2,16,'CW - Contract','sp',1,0,6),(2,17,'CW - Funding','sp',1,0,7),(2,18,'CW - Final Validation','sp',1,0,8),(3,19,'RW - List of merchants','sp',1,0,1),(3,20,'RW - Merchant Evaluation','sp',1,0,2),(3,21,'RW - Document Verification','sp',1,0,3),(3,22,'RW - Offer Creation','sp',1,0,4),(3,23,'RW - Renewal Review','sp',1,0,5),(3,24,'RW - Contract','sp',1,0,6),(3,25,'RW - Funding','sp',1,0,7),(3,26,'RW - Final Validation','sp',1,0,8);
...
-- Dump completed on 2014-09-24 10:36:58
